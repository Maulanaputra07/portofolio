    ...
    <div className="bg-[#f7f7f7] text-[#2A2A2A] w-full h-full">
      <div className="w-full h-full relative">
        ...
        <div className="h-auto border border-black text-[#FAFAFA] text-center bg-[#BB2233] bg-opacity-90 select-none flex flex-col justify-center items-center py-16 relative overflow-hidden">
          <div>
            <p className="sm:text-9xl text-8xl font-caveat leading-tight">Maulana</p>
            <p className="font-playfair sm:text-4xl text-3xl pl-32 sm:-mt-10 -mt-8 tracking-wide">Putra Pamungkas</p>
          </div>

          <div className="sm:w-1/2 max-w-full sm:p-0 p-10 text-justify mt-2 leading-snug">
          ...
          <div className="absolute sm:top-0 top-1/2 sm:-right-12 -right-32 max-w-full">
            <img src={asset1} className="sm:opacity-100 opacity-10 hover:sm:opacity-100 hover:opacity-50 transition-all duration-300" alt="" />
          </div>
          ...
          >
            <iframe
              className="rounded-lg shadow-md max-w-md w-full hidden sm:block"
            ...
            <div className="px-9 py-4 flex gap-3 flex-col text-start">
              <div>
                <div className="border-b-2 border-black/35 flex h-fit items-center">
                  <h1 className="font-didact sm:text-3xl text-xl font-semibold py-2 text-[#941b0c] select-none">Junior Programmer Internship</h1>
                  <h1 className="font-staatliches sm:text-3xl text-xl">01</h1>
                </div>
                <p className="sm:text-md text-sm pt-3">Developed website and built an AI-powered chatbot using RASA, integrated seamlessly with WhatsApp. Collaborated with the team to implement features efficiently while enhancing my skills in web development, Python, and conversational AI. This internship strengthened my ability to deliver practical solutions that support business processes.</p>
              </div>
              <div>
                <div className="border-b-2 border-black/35 flex h-fit items-center">
                  <h1 className="font-didact sm:text-3xl text-xl font-semibold py-2 text-[#941b0c] select-none">Freelance Web Development Team</h1>
                  <h1 className="font-staatliches sm:text-3xl text-xl">02</h1>
                </div>
                <p className="sm:text-md text-sm pt-3">Formed a freelance web development team with peers to design, build, and deploy websites for various clients. Collaborated in project planning, front-end and back-end development, and deployment processes to deliver responsive and user-friendly websites. This experience improved my teamwork, project management, and technical skills in real client environments.</p>
              </div>
            </div>
          </div>
        </div>
